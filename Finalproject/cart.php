                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rp. <?php echo $sum;?></th><th><div class="flip"> <a href="success.php?id=<?php echo $user_id?>"> <div class="front"> confirm</div><div class="back"> purchase</div></a></div></th>
                        </tr>
                    </tbody>
                </table>
            </div>
